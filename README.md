...
**Современное решение для автоматизированной проверки тестов с использованием компьютерного зрения **
...
Сканер тестов использует многоступенчатый алгоритм обработки изображений для точного распознавания ответов:
...
### Главное меню
![image](https://github.com/user-attachments/assets/a79f6504-97d8-4b96-ab6e-ec8be1278cd1)
...
### Множественный выбор
![image](https://github.com/user-attachments/assets/e1a191f1-cfd9-476f-8ae8-09a74fb03e40)
...
Специальный режим для тестов с несколькими правильными ответами.
...
Инструмент для создания и настройки бланков тестов.
