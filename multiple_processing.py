"""
Модуль обработки тестов с множественным выбором
=============================================

Этот модуль предоставляет функциональность для обработки и анализа тестов с множественным выбором.
Основные возможности:
- Обработка изображений тестов с одним и двумя столбцами
- Распознавание отмеченных ответов
- Поддержка строгого и нестрогого режимов проверки
- Визуализация результатов с цветовыми маркерами

Основные компоненты:
1. Функции обработки изображений:
   - stackImages: объединение нескольких изображений в одно
   ...
   - draw_multiple_marks: отрисовка маркеров ответов
   - showMultipleAnswers: визуализация ответов
   - adjust_image: настройка параметров изображения

2. Основные функции обработки:
   - process_multiple_choice: обработка теста с множественным выбором
   - MultipleProcessor: класс для обработки тестов с одним столбцом

Типы маркеров:
- Зеленый (✓) - полностью правильный ответ
- Оранжевый (✓) - частично правильный ответ
- Синий (×) - неправильный ответ
- Серый (○) - пропущенный правильный ответ
...
- Обработанное изображение с маркерами
- Количество правильных ответов
- Процент правильных ответов
- Список правильных вопросов
- Детальная информация о неправильных ответах
"""
